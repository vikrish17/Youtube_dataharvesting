...
uri = f"mongodb+srv://vigneshkrishnan1798:Vikrish17@cluster0.wamwczs.mongodb.net/"
client = MongoClient(uri)
db = client["youtube_warehousing"]
collection = db["youtube"]

conn = sql.connect(host="localhost", user="root", password="Vikrish@17", database="youtube_data")
cursor = conn.cursor()
password = urllib.parse.quote("Vikrish@17")
con_str = f'mysql+pymysql://root:{password}@localhost:3306/youtube_data'
